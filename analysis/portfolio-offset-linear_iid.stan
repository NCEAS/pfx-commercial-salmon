...
model {
  ...
  for(i in 1:n_strategy) {
    b_1[1,i] ~ normal(0, b1_str_yr_tau);# year 1
    b_2[1,i] ~ normal(0, b2_str_yr_tau);# year 1
    #b_3[1,i] ~ normal(0, 2);# year 1
    for(t in 2:n_yr) {
      b_1[t,i] ~ normal(0, b1_str_yr_tau);
      b_2[t,i] ~ normal(0, b2_str_yr_tau);
  ...
  for(i in 1:n_strategy) {
    g_1[1,i] ~ normal(0, g1_str_yr_tau);# year 1
    g_2[1,i] ~ normal(0, g2_str_yr_tau);# year 1
    #g_3[1,i] ~ normal(0, 2);# year 1
    for(t in 2:n_yr) {
      g_1[t,i] ~ normal(0, g1_str_yr_tau);
      g_2[t,i] ~ normal(0, g2_str_yr_tau);
