...
library(date)
library(reshape2)
cfec <- feather::read_feather("data-generated/salmon.feather")

maxYear = 2016
cfec = filter(cfec, year %in% seq(1975,maxYear))

saveRDS(cfec, "data-generated/salmon_data_for_paper.rds")
...
saveRDS(cfecAnnual, file="data-generated/salmon-annual-for-modeling.rds")
...
saveRDS(cfecAnnual.diff, file="data-generated/salmon-diff-for-modeling.rds")
