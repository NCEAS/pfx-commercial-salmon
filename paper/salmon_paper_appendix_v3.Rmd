...
appendixPlot1 = ggplot(agg.annual, aes(year, people, colour = specDiv)) + geom_line() + facet_wrap(~ label, scale="free") + ylab("Participation") + xlab("Year") + theme_sleek()
...
appendixPlot2_p1 = ggplot(aggdiff, aes(specDiv, log(meanrev), colour = cv, label=label)) + xlab("Species diversity") +ylab("Ln (mean revenue)") + geom_text(size=2) + theme_sleek()

appendixPlot2_p2 = ggplot(aggdiff, aes(specDiv, cv, colour = log(meanrev), label=label)) + xlab("Species diversity") +ylab("CV") + geom_text(size=2) + theme_sleek() 

appendixPlot2_p3 = ggplot(aggdiff, aes(log(meanrev), cv, colour = specDiv, label=label)) + ylab("CV") + xlab("Ln (mean revenue)") + geom_text(size=2) + theme_sleek()
```
...
scale_colour_manual(values = c('CHNK'=cbPalette[1], 'CHUM'=cbPalette[2], 
    ...
    labels =c("Chinook","Chum","Coho","Pink","Sockeye")) + theme(legend.position="none") + theme_sleek()
...
scale_colour_manual(values = c('CHNK'=cbPalette[1], 'CHUM'=cbPalette[2], 
    'COHO'=cbPalette[3], 'PINK'=cbPalette[4], 'SOCK'=cbPalette[5])) + theme_sleek()
...
scale_colour_manual(values = c('CHNK'=cbPalette[1], 'CHUM'=cbPalette[2], 
    'COHO'=cbPalette[3], 'PINK'=cbPalette[4], 'SOCK'=cbPalette[5]), name = "Species", labels =c("Chinook","Chum","Coho","Pink","Sockeye")) + theme(legend.position="none") + theme_sleek()
...
g1 = ggplot(diffdat, aes(log(weight)-log(weight.prev), specDiv.change)) + geom_point(alpha=0.15, col="blue", size=0.4) + facet_wrap(~ strategy_permit) + xlab("Change in ln annual landed weight") + ylab("Change in effective species diversity") + theme_sleek()
g1
```
