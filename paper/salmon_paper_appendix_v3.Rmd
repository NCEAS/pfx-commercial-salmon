...
g1 = ggplot(g, aes(year, mean)) + geom_ribbon(aes(ymin = lower, ymax = upper), alpha=0.3, fill="blue") + geom_line(color="blue") + facet_wrap(~strategy_permit) + xlab("Year") + ylab("Change in effective catch diversity") + theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),
panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))
...
g1 = ggplot(df[df$diversity==1,], aes(x=years,y=pred,group=permits)) +
  ...
  facet_wrap(~permits) + xlab("Year") + ylab("Predicted marginal effect") + geom_hline(yintercept=0, color="red") + theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),
panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))
g1
``` 
